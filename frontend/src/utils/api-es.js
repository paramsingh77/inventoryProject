...
// Configure axios defaults with production URL
const api = axios.create({
  baseURL: process.env.REACT_APP_API_URL || 'https://backendinventory-production.up.railway.app',
  timeout: 30000,
  headers: {
...
console.log('API baseURL:', process.env.REACT_APP_API_URL || 'https://backendinventory-production.up.railway.app');
